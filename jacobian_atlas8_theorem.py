"""
Note 10, stage E - THE THEOREM SWEEP.
...
Sweep d = 2..8 (fiber 3..9) and certify EVERY chamber:
...
print("="*96)
print("chamber sweep d = 2..8  (fiber n = d+1 = 3..9)")
...
for d in range(2, 9):
    ...
    terms = len(P.terms())
    pred_terms = (n*n + 3)//2 if n % 2 else n*n//2 + 2
    # s^n magnitude law
    ...
    if d <= 7:
        ...
        elim = sp.sympify(open("atlas8_elim_raw.txt").read())
    ppw = pp.subs(w, w2)
...
for d, fn in [(5, "atlas5_wall.txt"), (6, "atlas6_wall.txt"), (7, "atlas7_wall.txt"), (8, "atlas8_wall.txt")]:
...
json.dump(report, open("atlas8_theorem.json","w"), indent=1, default=str)
