...
b64 = base64.b64encode(open("jacobian_limits_figure.png", "rb").read()).decode()

md = r"""# JACOBIAN LAB — Note 12: **The Limit Shadow** 🚂🌑
### Why the whole tower dreams of the original cubic — and why 8.64% is a theorem, not a coincidence

*Date: 2026-07-20 (late shift). Instruments: sympy 1.14 (exact + Sturm), mpmath @ 50–120 digits (quadrature, Newton),
...
open("jacobian_limit_shadow.md", "w").write(md)
print("wrote jacobian_limit_shadow.md, bytes:", len(md))
