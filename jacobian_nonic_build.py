"""Assemble note 10: jacobian_nonic_atlas.md (figure inlined as base64, one-shot build)."""
import base64

png = base64.b64encode(open("/home/user/atlas8_atlas.png","rb").read()).decode()
wall = open("/home/user/atlas8_wall.txt").read()

md = r"""# 🔬 Note 10 · THE NONIC CHAMBER — and the Plücker key
*lossless lab notes, 2026-07-20 late shift · the counterexample tower, fiber degree 9 (seed d = 8, map F8)*
...
![the nonic atlas](data:image/png;base64,__PNG__)
...
md = md.replace("__PNG__", png).replace("__WALL__", wall)
open("/home/user/jacobian_nonic_atlas.md","w").write(md)
print("note written:", len(md), "chars")
